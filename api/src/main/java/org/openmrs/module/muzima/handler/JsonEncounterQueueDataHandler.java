...
/*
    ...
    protected static void useNewVisit(Encounter encounter) {
        String VISIT_SOURCE_FORM = "019a0b33-756b-4107-8cb7-7dbca47a3001";// 8bfab185-6947-4958-b7ab-dfafae1a3e3d
        ...
        visit.setVisitType(Context.getVisitService().getVisitTypeByUuid("ee11898b-5397-4358-bebc-07b48e10e9a7"));
// 3371a4d4-f66f-4454-a86d-92c7b3da990c
